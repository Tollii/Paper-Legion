...
public class Swordsman implements UnitType {
    ...
    public Swordsman(String type, double hp, int attack, int abilityCooldown, double defenceMultiplier, int minAttackRange, int maxAttackRange, int movementRage, String description){
        this.type = type;
        this.hp = hp;
        this.attack = attack;
